...
import com.ssw.recruit.service.RecruitService;
...
public class RecruitController {
    ...
    public ResultModel findAll() {
        return new ResultModel(true, StatusCode.OK, "查询成功", recruitService.findAll());
    }
    ...
    public ResultModel findById(@PathVariable String id) {
        return new ResultModel(true, StatusCode.OK, "查询成功", recruitService.findById(id));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new ResultModel(true, StatusCode.OK, "查询成功", new PageResult<Recruit>(pageList.getTotalElements(), pageList.getContent()));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap) {
        return new ResultModel(true, StatusCode.OK, "查询成功", recruitService.findSearch(searchMap));
    }
    ...
    public ResultModel add(@RequestBody Recruit recruit) {
    ...
    public ResultModel update(@RequestBody Recruit recruit, @PathVariable String id) {
        recruit.setId(id);
