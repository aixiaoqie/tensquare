package com.ssw.recruit.service;
...
import com.ssw.recruit.dao.EnterpriseDao;
...
public class EnterpriseService {
    ...
    public ResultModel getHotCityList(String s) {
        List<Enterprise> list = enterpriseDao.findByIshot(s);
