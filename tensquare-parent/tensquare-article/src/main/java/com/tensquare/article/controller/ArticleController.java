...
public class ArticleController {
    ...
    public ResultModel findAll() {
        return new ResultModel(true, StatusCode.OK, "查询成功", articleService.findAll());
    }
    ...
    public ResultModel findById(@PathVariable String id) {
        return new ResultModel(true, StatusCode.OK, "查询成功", articleService.findById(id));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new ResultModel(true, StatusCode.OK, "查询成功", new PageResult<Article>(pageList.getTotalElements(), pageList.getContent()));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap) {
        return new ResultModel(true, StatusCode.OK, "查询成功", articleService.findSearch(searchMap));
    }
    ...
    public ResultModel add(@RequestBody Article article) {
    ...
    public ResultModel update(@RequestBody Article article, @PathVariable String id) {
        article.setId(id);
