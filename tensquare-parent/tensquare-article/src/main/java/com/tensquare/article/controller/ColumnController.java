...
public class ColumnController {
    ...
    public ResultModel findAll() {
        return new ResultModel(true, StatusCode.OK, "查询成功", columnService.findAll());
    }
    ...
    public ResultModel findById(@PathVariable String id) {
        return new ResultModel(true, StatusCode.OK, "查询成功", columnService.findById(id));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new ResultModel(true, StatusCode.OK, "查询成功", new PageResult<Column>(pageList.getTotalElements(), pageList.getContent()));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap) {
        return new ResultModel(true, StatusCode.OK, "查询成功", columnService.findSearch(searchMap));
    }
    ...
    public ResultModel add(@RequestBody Column column) {
    ...
    public ResultModel update(@RequestBody Column column, @PathVariable String id) {
        column.setId(id);
