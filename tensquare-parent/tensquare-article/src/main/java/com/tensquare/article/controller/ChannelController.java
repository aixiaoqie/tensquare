...
public class ChannelController {
    ...
    public ResultModel findAll() {
        return new ResultModel(true, StatusCode.OK, "查询成功", channelService.findAll());
    }
    ...
    public ResultModel findById(@PathVariable String id) {
        return new ResultModel(true, StatusCode.OK, "查询成功", channelService.findById(id));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new ResultModel(true, StatusCode.OK, "查询成功", new PageResult<Channel>(pageList.getTotalElements(), pageList.getContent()));
    }
    ...
    public ResultModel findSearch(@RequestBody Map searchMap) {
        return new ResultModel(true, StatusCode.OK, "查询成功", channelService.findSearch(searchMap));
    }
    ...
    public ResultModel add(@RequestBody Channel channel) {
    ...
    public ResultModel update(@RequestBody Channel channel, @PathVariable String id) {
        channel.setId(id);
