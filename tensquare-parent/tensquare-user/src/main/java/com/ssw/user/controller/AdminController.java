...
import com.ssw.user.pojo.Admin;
import com.ssw.user.service.AdminService;
...
public class AdminController {
	...
	public ResultModel findAll(){
		return new ResultModel(true, StatusCode.OK,"查询成功",adminService.findAll());
	}
	...
	public ResultModel findById(@PathVariable String id){
		return new ResultModel(true,StatusCode.OK,"查询成功",adminService.findById(id));
	}
	...
	public ResultModel findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new ResultModel(true,StatusCode.OK,"查询成功",  new PageResult<Admin>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public ResultModel findSearch( @RequestBody Map searchMap){
        return new ResultModel(true,StatusCode.OK,"查询成功",adminService.findSearch(searchMap));
    }
	...
	public ResultModel update(@RequestBody Admin admin, @PathVariable String id ){
		admin.setId(id);
